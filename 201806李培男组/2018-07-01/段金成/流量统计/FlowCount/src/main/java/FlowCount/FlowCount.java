...
public class FlowCount {
    ...
    public static class FlowCountMapper extends  Mapper<LongWritable, Text, Text, IntWritable> {  // {}:java里面的包裹类体，方法和字段
     ...
     */
    public static class FlowCountReducer extends  Reducer<Text, IntWritable, Text, IntWritable>{
